...
class ChatOnlySeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $lawyers = User::where('role', 'lawyer')->take(2)->get();
        
        if ($clients->count() < 2 || $lawyers->count() < 2) {
            $this->command->error('Need at least 2 clients and 2 lawyers in the database');
            return;
        }
